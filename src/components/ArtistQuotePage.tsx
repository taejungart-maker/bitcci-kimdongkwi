    ...
    <div className="w-full h-full bg-white flex items-center justify-center px-8 py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl mx-auto text-center flex flex-col items-center">
        ...
        <motion.p
          ...
          className="text-[18px] md:text-[22px] text-gray-700 leading-[2.1] tracking-wide break-keep mb-2"
          style={{
        ...
        <motion.p
          ...
          className="text-[18px] md:text-[22px] text-gray-700 leading-[2.1] tracking-wide break-keep"
          style={{
            fontFamily: "'Noto Serif', 'Noto Sans KR', serif",
            fontStyle: 'italic',
          }}
        ...
        >
          ...
          <p
            className="text-[10px] text-gray-400 tracking-[0.5em] uppercase"
      ...
      <motion.p
        ...
        className="absolute bottom-6 left-1/2 -translate-x-1/2 text-[10px] text-gray-400 tracking-[0.4em] uppercase whitespace-nowrap"
        style={{ fontFamily: "'Montserrat', sans-serif" }}
      >
        Artist Statement
      </motion.p>
